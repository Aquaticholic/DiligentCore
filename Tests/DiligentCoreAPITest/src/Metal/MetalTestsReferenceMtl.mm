...
void RayTracingReferenceMtl(ISwapChain* pSwapChain)
{
    ...
    if (@available(macos 11.0, ios 14.0, *))
    {
        @autoreleasepool
        {
            auto* progSrc = [NSString stringWithUTF8String: MSL::RayTracing_CS.c_str()];
...
void ThreadgroupMemoryReferenceMtl(ISwapChain* pSwapChain)
{
    ...
    @autoreleasepool
    {
        auto* progSrc = [NSString stringWithUTF8String:MSL::ThreadgroupMemory_CS.c_str()]; // Autoreleased
        NSError *errors = nil; // Autoreleased
